...
public class bo extends OpMode {
    ...
    public void loop() {
        ...
        Pose2d pose2 = new Pose2d(50, 31, Math.toRadians(0));
        Pose2d pose1 = new Pose2d(-36, 31, Math.toRadians(180));

        Pose2d pose1r = new Pose2d(-36, 34, Math.toRadians(0));
        Pose2d pose2r = new Pose2d(50, 35, Math.toRadians(180));

        Pose2d pose1c = new Pose2d(-32, 34, Math.toRadians(270));
        Pose2d pose2c = new Pose2d(50, 28, Math.toRadians(180));
...
//            sleep(500);
    ...
    class examplePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Rect centerRect = new Rect(270, 30, 50, 50);
